...
SECRET_KEY = "django-insecure-p%(+h7r2&83k1_7s=5g3=g6yy+u2)#m2@1zujpao)2#74g-cmb"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_NAME", "menubackend"),
        "USER": os.environ.get("POSTGRES_USER", "docker"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "docker"),
        "HOST":  os.environ.get("POSTGRES_ADDRESS", "127.0.0.1"),
        "PORT": os.environ.get("POSTGRES_PORT", 6002),
    }
}
...
EMAIL_HOST_USER = 'fasteatcompany@gmail.com'
EMAIL_PORT = 587
